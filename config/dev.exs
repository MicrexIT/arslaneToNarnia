...
config :arslane_to_narnia, ArslaneToNarnia.Repo,
  username: "postgres",
  password: "postgres",
  database: "arslane_to_narnia_dev",
  hostname: "localhost",
...
config :arslane_to_narnia, ArslaneToNarniaWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/arslane_to_narnia_web/(live|views)/.*(ex)$",
      ~r"lib/arslane_to_narnia_web/templates/.*(eex)$"
    ]
  ]
...
config :arslane_to_narnia, :aws,
  # access_key_id: System.get_env("AWS_ACCESS_KEY_ID"),
  # secret_access_key: System.get_env("AWS_SECRET_ACCESS_KEY")
  access_key_id: "AKIAUKQTWIQEEMI6BBUY",
  secret_access_key: "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"

config :arslane_to_narnia, :env, :dev
