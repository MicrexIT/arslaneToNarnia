defmodule ArslaneToNarnia.AwsUpload do
  @moduledoc """
  ...
  def get_config() do
    %{
      region: "eu-west-3",
      access_key_id: ArslaneToNarnia.config([:aws, :access_key_id]),
      secret_access_key: ArslaneToNarnia.config([:aws, :secret_access_key])
    }
  end
