defmodule ArslaneToNarnia.Accounts.UserToken do
  @moduledoc """
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, ArslaneToNarnia.Accounts.User
  ...
  def create_pin(user, length \\ 6) do
  ...
  @doc "Check if a user has any current pins"
