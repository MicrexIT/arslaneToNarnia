defmodule ArslaneToNarnia.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ArslaneToNarnia.Repo)
  ...
  """
  def valid_password?(%ArslaneToNarnia.Accounts.User{hashed_password: hashed_password}, password)
