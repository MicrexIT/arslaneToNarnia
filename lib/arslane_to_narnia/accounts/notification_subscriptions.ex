defmodule ArslaneToNarnia.Accounts.NotificationSubscriptions do
  ...
  def toggle_user_subscription(user, notification_subscription_name) do
    ...
    if notification_subscription do
      ...
      case ArslaneToNarnia.Accounts.update_user_as_admin(user, user_updates) do
        {:ok, _user} ->
          true
  ...
  def unsubscribe_url(user, notification_subscription_name) do
    ArslaneToNarniaWeb.Router.Helpers.user_settings_url(
