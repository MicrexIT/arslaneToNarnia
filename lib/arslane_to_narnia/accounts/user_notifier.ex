defmodule ArslaneToNarnia.Accounts.UserNotifier do
  @moduledoc """
  When sending an email we use the functions in ArslaneToNarnia.Email to generate the Email struct ready for Swoosh to send off.
  ...
  """
  alias ArslaneToNarnia.{Email, Mailer}
  require Logger
  ...
  defp deliver_non_essential_email(email, recipient_user) do
