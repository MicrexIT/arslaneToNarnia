defmodule ArslaneToNarniaWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ArslaneToNarniaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ArslaneToNarniaWeb.Gettext, "errors", msg, opts)
    end
  end
