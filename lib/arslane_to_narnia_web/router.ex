defmodule ArslaneToNarniaWeb.Router do
  use ArslaneToNarniaWeb, :router

  alias ArslaneToNarniaWeb.Router.Helpers, as: Routes
  import ArslaneToNarniaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ArslaneToNarniaWeb.LayoutView, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers
    plug :fetch_current_user
    plug ArslaneToNarniaWeb.SetLocalePlug, gettext: ArslaneToNarniaWeb.Gettext
  ...
  scope "/", ArslaneToNarniaWeb do
    ...
    live_session :public,
      on_mount: [
        {ArslaneToNarniaWeb.UserOnMountHooks, :maybe_assign_user},
        {ArslaneToNarniaWeb.UserOnMountHooks, :assign_color_scheme}
      ] do
  ...
  scope "/", ArslaneToNarniaWeb do
    ...
    live_session :require_authenticated_user_for_onboarding,
      on_mount: [
        {ArslaneToNarniaWeb.UserOnMountHooks, :require_authenticated_user},
        {ArslaneToNarniaWeb.UserOnMountHooks, :assign_color_scheme}
      ] do
  ...
  scope "/", ArslaneToNarniaWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/projects", ProjectPublicLive.Index, :index
      live "/projects/new", ProjectPublicLive.Index, :new
      live "/projects/:id", ProjectPublicLive.Show, :show
  ...
  scope "/admin", ArslaneToNarniaWeb do
    pipe_through [
      :browser,
      :require_admin_user,
      :kick_user_if_suspended_or_deleted
    ...
    live_session :require_admin_user,
      on_mount: [
        {ArslaneToNarniaWeb.UserOnMountHooks, :require_admin_user},
        {ArslaneToNarniaWeb.UserOnMountHooks, :assign_color_scheme}
      ] do
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ArslaneToNarniaWeb.Telemetry
      ...
      scope "/emails" do
        ...
        get "/", ArslaneToNarniaWeb.EmailTestingController, :index
        get "/sent", ArslaneToNarniaWeb.EmailTestingController, :sent
        get "/preview/:email_name", ArslaneToNarniaWeb.EmailTestingController, :preview

        post "/send_test_email/:email_name",
             ArslaneToNarniaWeb.EmailTestingController,
             :send_test_email

        get "/show/:email_name", ArslaneToNarniaWeb.EmailTestingController, :show_html
      end
    end
  ...
  defp onboard_new_users(conn, _opts) do
    if conn.assigns[:current_user] && !conn.assigns.current_user.is_onboarded do
      conn
      |> redirect(to: Routes.live_path(conn, ArslaneToNarniaWeb.UserOnboardingLive))
      |> halt()
    else
      conn
    end
  ...
  # For live view it sets it on the session (use {ArslaneToNarniaWeb.UserOnMountHooks, :assign_color_scheme} as a hook - see https://hexdocs.pm/phoenix_live_view/security-model.html#mounting-considerations)
