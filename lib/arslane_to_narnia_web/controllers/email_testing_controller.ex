defmodule ArslaneToNarniaWeb.EmailTestingController do
  use ArslaneToNarniaWeb, :controller
  alias ArslaneToNarnia.Mailer
  alias ArslaneToNarnia.Email
  ...
  def preview(conn, %{"email_name" => email_name}) do
    conn
    |> put_root_layout({ArslaneToNarniaWeb.LayoutView, "empty.html"})
    |> render(
      "index.html",
      %{
