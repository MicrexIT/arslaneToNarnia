defmodule ArslaneToNarniaWeb.LogsLive do
  @moduledoc """
  ...
  alias ArslaneToNarnia.Logs.{LogQuery}
  alias ArslaneToNarniaWeb.LogsLive.SearchChangeset
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      ArslaneToNarniaWeb.Endpoint.subscribe("logs")
    end
