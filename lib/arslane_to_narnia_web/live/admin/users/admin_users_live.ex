defmodule ArslaneToNarniaWeb.AdminUsersLive do
  @moduledoc """
  A live view to admin users on the platform (edit/suspend/delete).
  """
  use ArslaneToNarniaWeb, :live_view
  alias ArslaneToNarnia.{Accounts, Repo}
  alias ArslaneToNarnia.Accounts.UserQuery
  alias ArslaneToNarniaWeb.AdminUsersLive.UserFilterChangeset
