defmodule ArslaneToNarniaWeb.PageBuilderLive do
  @moduledoc """
  ...
  alias ArslaneToNarnia.PageChangeset
  ...
  def render(assigns) do
    ~H"""
    <ArslaneToNarniaWeb.DevLayoutComponent.dev_layout
  ...
  def create_page(%{type: "static"} = page) do
    PageBuilder.make_changes([
      [
        ...
        file_path: "lib/arslane_to_narnia_web/router.ex",
      ...
      [
        ...
        destination_file_path:
          "lib/arslane_to_narnia_web/templates/page/#{page.controller_function_name}.html.heex",
        assigns: %{
      ...
      [
        ...
        file_path: "lib/arslane_to_narnia_web/controllers/page_controller.ex",
        code: """
  ...
  def create_page(%{type: "live"} = page) do
    PageBuilder.make_changes([
      ...
      [
        ...
        destination_file_path:
          "lib/arslane_to_narnia_web/live/#{Macro.underscore(page.live_view_module_name)}.ex",
        assigns: %{
          title: page.page_title,
          layout: page.layout,
  ...
  defp get_route_sections(changeset) do
    router = File.read!("lib/arslane_to_narnia_web/router.ex")
