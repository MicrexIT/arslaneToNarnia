defmodule ArslaneToNarniaWeb.UserSettingsControllerTest do
  use ArslaneToNarniaWeb.ConnCase, async: true

  alias ArslaneToNarnia.Accounts
  import ArslaneToNarnia.AccountsFixtures
  ...
  describe "PUT /users/settings (change password form)" do
    test "updates the user password and resets tokens", %{conn: conn, user: user} do
      ...
      assert redirected_to(new_password_conn) ==
               Routes.live_path(conn, ArslaneToNarniaWeb.EditPasswordLive)
  ...
  describe "GET /users/settings/confirm_email/:token" do
    ...
    test "updates the user email once", %{conn: conn, user: user, token: token, email: email} do
      ...
      assert redirected_to(conn) == Routes.live_path(conn, ArslaneToNarniaWeb.EditProfileLive)
  ...
  describe "GET /users/unsubscribe/:code/:notification_subscription" do
    test "renders an unsubscribe page for that notification subscription", %{
      ...
      unsub_url =
        ArslaneToNarnia.Accounts.NotificationSubscriptions.unsubscribe_url(
          user,
      ...
      assert response =~
               ArslaneToNarnia.Accounts.NotificationSubscriptions.get("marketing_notifications").label
    end
  end
