defmodule ArslaneToNarniaWeb.SetLocalePlugPlugTest do
  use ExUnit.Case
  import Plug.Conn
  import Phoenix.ConnTest
  alias ArslaneToNarniaWeb.SetLocalePlug

  defmodule MyGettext do
    use Gettext, otp_app: :arslane_to_narnia
  end
